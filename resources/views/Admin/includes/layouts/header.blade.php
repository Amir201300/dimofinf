        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('admin.dashboard')}}">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Dark Logo icon -->
                    <img  src="{{asset('Admin/logo.png')}}" alt="homepage" class="dark-logo" />
                    <!-- Light Logo icon -->
                    <img  src="{{asset('Admin/logo.png')}}" width="90px" alt="homepage" class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                       aria-expanded="false">
                        ...
                        <img src="{{asset('Admin/admin.png')}}" alt="user" class="rounded-circle" width="31">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            <div class="">
                                <img src="{{asset('Admin/admin.png')}}" alt="user" class="img-circle" width="60">
                            </div>
                            <div class="m-l-10">
